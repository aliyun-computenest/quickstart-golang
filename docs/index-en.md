<h1> Quickly deploy the Golang runtime environment </h1>

<h2> Overview </h2>

<p>Golang is a statically typed, compiled programming language designed by Google's Robert Griesemer, Rob Pike and Ken Thompson in 2007 and officially released in 2009. The goal of Go language design is to achieve efficient compilation, efficient execution, and easy programming and efficient data processing. For more information, see <a href = "https://go.p2hp.com/">Golang official website </a>. </p>

<p> This service supports deployment on existing ECS instances (Linux) and deployment on new ECS instances (Linux). </p>

<h2> Billing instructions </h2>

<p> The cost of deploying the Golang operating environment on the computing nest mainly involves:</p>
...
<ol>
<li> Click <a href = "https://computenest.console.aliyun.com/service/instance/create/default?type=user&ServiceName=Golang%E8%BF%90%E8%A1%8C%E7%8E%AF%E5%A2%83"> Deployment Link </a> to go to the Service Instance Deployment page. </li>
...
<li><p> Run the command on ECS to view the Golang installation result. </p>

<div class="codehilite">
<pre><span></span><code>go<span class="w"> </span>version
</code></pre>
</div>
